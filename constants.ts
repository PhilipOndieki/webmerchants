...
export const WA_PRICING_MESSAGE = encodeURIComponent(
  "Hi Webmerchants, I'd like to discuss pricing for my website."
)
export const WA_TOPIC_MESSAGE = encodeURIComponent(
