      ...
      <div className="px-6 lg:px-12">
        ...
        <div className="border-t border-wm-border mt-12 pt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://x.com/webmerchants_ke"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://web.facebook.com/profile.php?id=61590472769023"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="text-wm-grey hover:text-gold transition-colors duration-200"
            ...
            <a
              href="https://www.linkedin.com/in/webmerchants-kenya-816109412"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="text-wm-grey hover:text-gold transition-colors duration-200"
            ...
            <a
              href="https://www.tiktok.com/@webmerchants30"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="TikTok"
              className="text-wm-grey hover:text-gold transition-colors duration-200"
            ...
            <a
            href="https://www.instagram.com/webmerchants_ke/"
              target="_blank"
              rel="noopener noreferrer"
